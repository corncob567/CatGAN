...
train_images = train_images.reshape(train_images.shape[0], INPUT_DIMENSION, INPUT_DIMENSION, 3).astype('float32')
...
def make_generator_model():
    ...
    model.add(layers.Reshape((8, 8, 256))) # The Dense layer outputs 8x8x256 activations that are then reshaped into 256 feature maps with the shape 8x8
